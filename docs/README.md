...
| **[Using LiveChart](using.md)** | The toolbar, key and capo, performance mode, tap zones, and teaching the app what your pedal sends. |
...
This guide covers what the app does today, and nothing it doesn't do yet.
