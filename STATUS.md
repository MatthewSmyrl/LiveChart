...
| Where that line sits | **Lyrics and whole charts are the concern; a handful of chord symbols is not.** Matt's call, 2026-09-05, on `TRANSPOSITION-PLAN.md` §1.4 quoting five chords of *That Funny Feeling* to show the `Key − Capo` convention: a bare progression is not distinctive enough to carry anything copyrightable. Naming a song is likewise fine — `STATUS.md` has always done it. Lyric fragments were removed from this file on 2026-08-11 and that still stands |
